...
Go to [copilot.microsoft.com](copliot.microsoft.com) use your Uni of Leeds IT account to sign in. The shield in the top right tells you it is secure. Use it in the challenges below to help you write code.
...
The [university has guidance](https://generative-ai.leeds.ac.uk) on stating that you have used AI in an acknowledgement or declaration section at the end of your work. An example is below.
