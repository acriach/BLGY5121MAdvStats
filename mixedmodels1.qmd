...
![alt.text=Three colourful cartoon dragons.](./img/dragons.png)
...
![alt.text=one blue cartoon dragon](./img/blue_dragon.png)
...
![alt.text=a close up of barley growing with a black background.](./img/barley.jpg)
...
![alt.text=a swallowtail caterpillar with green and black stripes with orange spots](./img/cat.jpg)
...
![alt.text=a diagram of a cartoon petri dish with 10 yellow spots on it](./img/petri.png)
