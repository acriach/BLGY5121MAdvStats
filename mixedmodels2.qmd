...
Report the analysis. Include a graph. Did including the tank in the model change the results?
...
Decide for each of the below if you would consider as having a nested, partial crossed or fully crossed design. 

1) Students (studentID) are measured for statistics ability repeatedly in tests (testScore). The effects of gender, prior education are fixed effects. Students study different programmes.
