...
Analyse these datasets using PCA. The plot function is fine for visualising the results yourself but to present results experiment using `ggbiplot()` which gives you more control.
