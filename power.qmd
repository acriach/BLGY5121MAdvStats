...
There are various packages which do power analysis in R. [pwr](https://cran.r-project.org/web/packages/pwr/index.html) is for simpler analyses such as t tests and ANOVAs, up to `lm`. [simR](https://cran.r-project.org/web/packages/simr/index.html) and [WebPower](https://cran.r-project.org/web/packages/WebPower/WebPower.pdf) are for more complex mixed model glms.
...
Use the effect size d = 0.29 as reported in [Osbrink et al, 2021](https://doi.org/10.1098/rspb.2020.2851).
